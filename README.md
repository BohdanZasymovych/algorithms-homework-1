...
Порівняння проводилось з використання функції `sizeof` та визначення кількості пам'яті необхідної для збереження даних в структури, однак додаткові метадані, які необхідні для збереження самих структур та їх властивостей не були враховані.
...
Крім того, вбудована реалізація високооптимізована, що забезпечує кращий час виконання.
