...
std::vector<Student*> StudentBase2::getStudentsByName(const std::string& m_name, const std::string& m_surname) {
...
std::unordered_set<std::string> StudentBase2::getGroupsSameStudentName() {
...
void StudentBase2::changeGroupByEmail(const std::string& m_email, const std::string& newGroup) {
...
StudentBase2 StudentBase2::fromCSV(const std::string& pathToCSV) {
    StudentBase2 studentBase;
...
void StudentBase2::saveToCSV(const std::vector<Student>& studentsToSave, const std::string& pathToSave) {
